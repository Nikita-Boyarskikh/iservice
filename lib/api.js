...
import { ITEM_FEATURES, MESSAGE_STATUSES, PAYMENT_METHOD_TYPES, PLACE_STATUSES, PLACE_TYPES } from 'constants'
    ...
    setTimeout(() => resolve([
      ...
      },
      {
        ...
        messages: [
          {
            text: 'Ок',
            status: MESSAGE_STATUSES.UNREAD,
            createdAt: new Date(),
          },
        ],
      },
